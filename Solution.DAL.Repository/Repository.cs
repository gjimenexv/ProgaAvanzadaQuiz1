...
{
    public class Repository<T> : IRepository<T> where T : class // Puedo decirle que utilice cualquier objeto de tipo clase, creando asi una libreria
    {
        ...
        public IQueryable<T> AsQueryble() // Es como decir un select all.
        {
